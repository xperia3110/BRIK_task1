...
class _FinanceScreenState extends State<FinanceScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xFF059669), // Green background
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // COMPANY DESCRIPTION
                      const Text(
                        'The Goldman Sachs Group, Inc. is an American multinational investment bank and financial services company. Founded in 1869, Goldman Sachs is headquartered in Lower Manhattan in New York City. The company is a leading global investment banking, securities and investment management firm that provides a wide range of financial services to corporations, financial institutions, governments and individuals worldwide.',
                        style: TextStyle(
                          fontSize: 16,
